...
are multiple pivot indexes, you should return the left-most
pivot index.
Example 1:
	Input:  [1, 7, 3, 6, 5, 6]
	Output: 3
	Explanation:The sum of the numbers to the left of index 3
(nums[3] = 6) is equal to the sum of numbers to the right of
...
Note:
	 ...
	 2.Each element nums[i] will be an integer in the
	   range [-1000, 1000].
"""
class Solution:
