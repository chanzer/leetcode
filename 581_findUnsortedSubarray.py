...
continuous subarray that if you only sort this subarray in
ascending order, then the whole array will be sorted in
ascending order, too.
...
Note:
	...
	2.The input array may contain duplicates, so ascending
	  order here means <=.
"""
class Solution:
