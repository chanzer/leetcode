...
Example:
	...
	Output:[1,2,3,4]
Explanation:
	The row-traversing of nums is [1,2,3,4]. The new
reshaped matrix is a 1 * 4 matrix, fill it row by row by
using the previous list.
Note:
	1.The height and width of the given matrix is in
	  range [1, 100].
